...
public class AssessmentController {
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "completedDateFrom", description = "Filter by completion date from (ISO format)"),
    ...
    public ResponseEntity<JsonApiResponse<List<AssessmentDto>>> searchAssessments(
        ...
        @Parameter(hidden = true) @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime completedDateFrom,
